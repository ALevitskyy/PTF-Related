...
def testRandomCageOverlay():
    ...
    cv2.imwrite(
        "testresultimage.png", cv2.cvtColor(test_result["image"], cv2.COLOR_RGB2BGR)
    )
    cv2.imwrite(
        "testresultmask.png", cv2.cvtColor(test_result["mask"], cv2.COLOR_RGB2BGR)
    )
...
def testRandomInfoOverlay():
    ...
    cv2.imwrite(
        "testoverlayimage.png", cv2.cvtColor(test_result["image"], cv2.COLOR_RGB2BGR)
    )
    cv2.imwrite(
        "testoverlaymask.png", cv2.cvtColor(test_result["mask"], cv2.COLOR_RGB2BGR)
    )
