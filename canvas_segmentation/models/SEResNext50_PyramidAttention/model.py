...
class ResNetUnet(nn.Module):
    ...
    def __init__(
        ...
        self.logit = nn.Sequential(nn.Conv2d(768, 64, kernel_size=3, padding=1),
                                   nn.ELU(True),
    ...
    def forward(self, x):
        ...
        f = torch.cat((dec5,dec4,
                    ...
                    F.upsample(dec0, scale_factor=16, mode='bilinear', align_corners=True)),1) # 320, 256, 256
        logit = self.logit(f)
